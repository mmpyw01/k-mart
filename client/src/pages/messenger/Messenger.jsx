...
export default function Messenger() {
    ...
    //location.state.currentChat && currentChat == null && setCurrentChat(location.state.currentChat )
    ...
    return (
        <>
            ...
            {!currentChat && (location.state && setCurrentChat(location.state.currentChat ))}
